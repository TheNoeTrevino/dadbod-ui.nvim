...
M.defaults = {
  ...
  mappings = {
    sidebar = {
      ...
      move_up = { key = '<C-Up>', desc = 'Move connection up within its group' },
      move_down = { key = '<C-Down>', desc = 'Move connection down within its group' },
      cut = { key = 'x', desc = 'Cut a connection to move/paste it' },
      paste = { key = 'p', desc = 'Paste the cut connection here' },
      cancel_cut = { key = '<Esc>', desc = 'Cancel a pending cut' },
