...
`export/` - native CLI result export: `init.lua` (orchestration), `formats.lua` (pure formatters), `extract.lua` (output parsing), `adapters.lua` (capability access over the adapter specs).
