...
describe('formats.NULL', function()
...
describe('formats.csv: replacement strings with %', function()
...
describe('formats.markdown', function()
...
describe('formats.html', function()
